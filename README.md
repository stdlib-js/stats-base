...
```javascript
import stats from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base@v0.1.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base@v0.1.0-deno/mod.js';
