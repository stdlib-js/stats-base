...
```javascript
import { cumax, cumaxabs, cumin, cuminabs, dists, ndarray, sdsnanmean, snanstdev, snanstdevch, snanstdevpn, snanstdevtk, snanstdevwd, snanstdevyc, snanvariance, snanvariancech, snanvariancepn, snanvariancetk, snanvariancewd, snanvarianceyc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base@esm/index.mjs';
```
