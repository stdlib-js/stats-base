...
```javascript
import stats from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base@v0.4.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base@v0.4.0-deno/mod.js';
